...
const routes = [
  ...
  { path: '/mobile', name: 'MobileWork', component: () => import('../views/mobile/index.vue'), meta: { title: '移动扫码作业' } },
  {
    ...
    redirect: '/dashboard',
    children: [
      { path: 'operation-log', name: 'OperationLog', component: () => import('../views/operation-log/index.vue'), meta: { title: '日志中心' } },
      ...
      { path: 'checkout', name: 'CheckoutHistory', component: () => import('../views/checkout/index.vue'), meta: { title: '借用中心' } },
      { path: 'inventory', name: 'AccessoryManagement', component: () => import('../views/inventory/index.vue'), meta: { title: '配件管理', inventoryMode: 'parts' } },
      { path: 'software-license', name: 'SoftwareLicense', component: () => import('../views/inventory/index.vue'), meta: { title: '软件许可', inventoryMode: 'license' } },
      { path: 'location', name: 'Location', component: () => import('../views/location/index.vue'), meta: { title: '位置管理' } },
      { path: 'device-type', name: 'DeviceType', component: () => import('../views/device-type/index.vue'), meta: { title: '设备类型' } },
      { path: 'product', name: 'ProductCatalog', component: () => import('../views/product/index.vue'), meta: { title: '产品档案' } },
