...
const routes = [
  ...
  { path: '/mobile', name: 'MobileWork', component: () => import('../views/mobile/index.vue'), meta: { title: '移动扫码作业' } },
  {
    ...
    children: [
      ...
      { path: 'checkout', name: 'CheckoutHistory', component: () => import('../views/checkout/index.vue'), meta: { title: '领用历史' } },
      { path: 'inventory', name: 'InventoryItems', component: () => import('../views/inventory/index.vue'), meta: { title: '库存扩展' } },
